...
const validate = (values, pageContext) => {
  const errors = {};
  if (!values.title) {
...
const NewItemBar = ({
  ...
  <StyledWrapper isVisible={isVisible}>
    ...
    <Formik
      ...
      validate={(values) => validate(values, pageContext)}
    ...
    >
      {({
        ...
        <StyledForm>
          ...
          <StyledInput
            placeholder={(errors.twitterName) || 'twitter name eg. hello_roman'}
            type="text"
            name="twitterName"
            onChange={handleChange}
            onBlur={handleBlur}
          ...
          <StyledInput
            placeholder={(errors.articleUrl) || 'link'}
            type="text"
            name="articleUrl"
            onChange={handleChange}
            onBlur={handleBlur}
          ...
          <StyledTextArea
            name="content"
            placeholder={(errors.content) || 'text'}
            as="textarea"
            onChange={handleChange}
            onBlur={handleBlur}
